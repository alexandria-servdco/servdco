    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 lg:px-8 h-full flex items-center justify-between gap-6">
          ...
          >
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#FF8D6B] to-[#FF6A45] flex items-center justify-center shadow-[0_4px_18px_rgba(255,122,89,0.4)] transition-transform duration-300 group-hover:scale-[1.06] relative overflow-hidden">
              ...
              <svg viewBox="0 0 100 100" className="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" strokeWidth="7" strokeLinecap="round">
              ...
              <div className="flex justify-between items-center px-7 py-5 border-b border-white/[0.06]">
                <Link to="/" onClick={() => setMobileOpen(false)} className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#FF8D6B] to-[#FF6A45] flex items-center justify-center shadow-md">
                    <svg viewBox="0 0 100 100" className="w-4 h-4 text-white" fill="none" stroke="currentColor" strokeWidth="7" strokeLinecap="round">
                      <circle cx="50" cy="50" r="35" />
                      <circle cx="50" cy="50" r="19" />
                    </svg>
                  </div>
