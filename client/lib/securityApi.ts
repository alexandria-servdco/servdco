    ...
    try {
      res = await fetchWithTimeout("/api/auth/signup", {
        ...
        body: JSON.stringify({
          ...
          bio: params.bio,
          acceptTerms: params.acceptTerms === true ? true : undefined,
          acceptPrivacy: params.acceptPrivacy === true ? true : undefined,
          ...
          serviceRadiusMiles: params.serviceRadiusMiles ?? null,
        }),
        timeoutMs: 28_000,
      });
    } catch (err) {
