...
import { 
  Plus, Minus, ArrowRight, DollarSign, Calendar, Clock, ShieldCheck, Star, Users, MessageSquare 
} from "lucide-react";
...
export default function ForChefs() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-[#F5F5F5] font-sans selection:bg-[#FF7A59]/20 selection:text-[#FF7A59]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-[1.05] tracking-tight font-serif text-white">
                Turn your cooking<br />into real <span className="text-[#FF7A59]">income.</span>
              </h1>
              <p className="text-[#A8A8A8] text-base lg:text-lg leading-relaxed max-w-lg">
                Join a growing network of elite local chefs who prepare fresh home-cooked meals directly in family kitchens. Set your own hours, design your own menus, and keep 100% of your tips.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                >
                  Apply to Cook <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </Link>
                <a
                  href="#calculator"
              ...
              <div className="w-full aspect-[4/3] rounded-[32px] overflow-hidden shadow-2xl border border-white/5 relative">
                ...
                <div className="absolute bottom-8 left-8 right-8 flex gap-4">
                  <div className="bg-[#2A2A2A]/90 backdrop-blur-md rounded-2xl p-4 border border-white/5 flex-1 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#A8A8A8] uppercase tracking-wider font-bold">Flexibility</p>
                      <p className="text-sm font-bold text-white">100% Own Schedule</p>
                    </div>
                  </div>
                  <div className="bg-[#2A2A2A]/90 backdrop-blur-md rounded-2xl p-4 border border-white/5 flex-1 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#A8A8A8] uppercase tracking-wider font-bold">Earnings</p>
                      <p className="text-sm font-bold text-white">Up to $1.2k/week</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-[#161616] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <p className="text-[#FF7A59] font-bold text-xs uppercase tracking-widest">Why Cook With Servd Co?</p>
            <h2 className="text-4xl font-bold font-serif text-white">Built for local culinary talent</h2>
            <p className="text-[#A8A8A8] text-sm">We provide the client discovery, schedule tooling, billing pipelines, and client support so you can focus entirely on creating exceptional culinary experiences.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-[#2A2A2A] rounded-[24px] p-8 border border-white/5 hover:border-white/10 transition-colors shadow-2xl">
                <div className={`w-12 h-12 rounded-2xl ${v.bg} flex items-center justify-center ${v.color} mb-6`}>
                  <v.icon size={22} />
                </div>
                <h3 className="text-xl font-bold text-white mb-3">{v.title}</h3>
                <p className="text-[#A8A8A8] text-sm leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="calculator" className="py-24 bg-[#111111] border-b border-white/5 relative">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-8">
              <div>
                <p className="text-[#FF7A59] font-bold text-xs uppercase tracking-widest mb-3">Earnings Estimator</p>
                <h2 className="text-4xl font-bold font-serif text-white mb-4">Calculate your weekly potential</h2>
                <p className="text-[#A8A8A8] text-sm leading-relaxed">
                  Choose the number of cooking sessions you plan to host each week. We calculate your estimated earnings using flat rates per session type.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#161616] rounded-2xl p-6 border border-white/5 flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-white text-base">Breakfast Sessions</h3>
                    <p className="text-[#A8A8A8] text-xs mt-0.5">$40 per session fee</p>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xl font-bold text-white w-6 text-center">{breakfastSessions}</span>
                    <button 
                ...
                <div className="bg-[#161616] rounded-2xl p-6 border border-white/5 flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-white text-base">Dinner Sessions</h3>
                    <p className="text-[#A8A8A8] text-xs mt-0.5">$60 per session fee</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <button 
                    ...
                    <span className="text-xl font-bold text-white w-6 text-center">{dinnerSessions}</span>
                    <button 
                ...
                <div className="bg-[#161616] rounded-2xl p-6 border border-white/5 flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-white text-base">Meal Prep Sessions</h3>
                    <p className="text-[#A8A8A8] text-xs mt-0.5">$70 per session fee</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <button 
                    ...
                    <span className="text-xl font-bold text-white w-6 text-center">{mealPrepSessions}</span>
                    <button 
                ...
                <div className="bg-[#161616] rounded-2xl p-6 border border-white/5 flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-white text-base">Guest / Larger Family Bookings</h3>
                    <p className="text-[#A8A8A8] text-xs mt-0.5">Adds flat +$10 fee to every session</p>
                  </div>
                  <button 
                  ...
                  >
                    <span className={`w-4 h-4 rounded-full bg-white absolute top-0.5 transition-all ${familyFees ? 'left-[26px]' : 'left-1'}`} />
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 lg:sticky lg:top-28">
              <div className="bg-[#2A2A2A] rounded-[32px] p-10 border border-white/5 shadow-2xl relative overflow-hidden">
                ...
                <h3 className="font-bold text-white text-lg font-serif mb-8 border-b border-white/5 pb-4">Earning Breakdown</h3>

                <div className="space-y-6">
                  <div>
                    <p className="text-xs text-[#A8A8A8] uppercase tracking-wider font-bold mb-1">Weekly Potential</p>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-white font-serif">${weeklyEarning}</span>
                      <span className="text-[#A8A8A8] text-sm">/ week</span>
                    </div>
                  </div>

                  <div>
                    <p className="text-xs text-[#A8A8A8] uppercase tracking-wider font-bold mb-1">Monthly Potential</p>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-[#FF7A59] font-serif">${monthlyEarning}</span>
                  ...
                  <div className="pt-6 border-t border-white/5 space-y-4">
                    <div className="flex justify-between text-xs text-[#A8A8A8]">
                      ...
                      <span className="font-semibold text-white">{breakfastSessions}</span>
                    </div>
                    <div className="flex justify-between text-xs text-[#A8A8A8]">
                      <span>Dinner sessions:</span>
                      <span className="font-semibold text-white">{dinnerSessions}</span>
                    </div>
                    <div className="flex justify-between text-xs text-[#A8A8A8]">
                      <span>Meal prep sessions:</span>
                      <span className="font-semibold text-white">{mealPrepSessions}</span>
                    </div>
                    <div className="flex justify-between text-xs text-[#A8A8A8]">
                      <span>Guest fee enabled:</span>
                      <span className="font-semibold text-white">{familyFees ? "Yes (+$10/session)" : "No"}</span>
                    </div>
                  </div>
