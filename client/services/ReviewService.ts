...
export const ReviewService = {
  ...
  async getReviews(): Promise<Review[]> {
    ...
    return [
      { id: "rev-1", chefId: "chef-maria", name: "Jessica M.", rating: 5, text: "Cook Maria's meals are absolutely delicious! My kids love the homemade organic chicken pot roast. Grateful for her tidy cleanup!", date: "May 20, 2026", verified: true },
